...
const ITEM_DATABASE = [
    ...
    },
    {
        ...
        rateGain: 10,
        icon: "💠",
        desc: "Tinh hoa ngưng tụ từ thiên địa chi lực sau khi thông qua khảo nghiệm Ải 23: Vấn Thiên Địa (Chiến lợi phẩm độc quyền rơi từ Ải 23, không bán tại Bách Bảo Các). Khi phục dụng gia tăng +10% tỉ lệ độ kiếp trong cảnh giới / chu kỳ hiện tại (không bị mất khi độ kiếp thất bại, làm mới khi thăng đại cảnh giới)."
    },
    {
